 ...
 *,-------+--------+------+------+------+------+------|                                                |------+------+------+------+------+--------+-------.
 *| GRAVE |Ctrl/Esc|   A  |   S  |   D  |   F  |   G  |                                                |   H  |   J  |   K  |   L  | ;  : |Ctrl/' "| RBRC  |
 *`-------+--------+------+------+------+------+------|                                                |------+------+------+------+------+--------+-------'
 *        | Enter  |   Z  |   X  |   C  |   V  |   B  |                                                |   N  |   M  | ,  < | . >  | /  ? |  Bksp  |
 *        `----------------------+------+------+------+--|-----------------.      .-----------------|--+------+------+------+----------------------'
 *                               | Menu | LALT | NAV  | Shift| Space| Nav  |      | Space| Sym  | Space|  SYM | RGUI |GAMING|                                 
 *                               |      |      |      |      |      |      |      |      |      |      |      |      |      |                                 
 *                               `-----------------------------------------'      `-----------------------------------------'                                 
 */
    [_QWERTY] = LAYOUT(\
              KC_TAB  , KC_Q ,  KC_W   ,  KC_E  ,   KC_R ,   KC_T ,                                        KC_Y,   KC_U ,  KC_I ,   KC_O ,  KC_P , KC_LBRC, \
     KC_GRV , CTL_ESC , KC_A ,  KC_S   ,  KC_D  ,   KC_F ,   KC_G ,                                        KC_H,   KC_J ,  KC_K ,   KC_L ,KC_SCLN,CTL_QUOT, KC_RBRC, \
              KC_ENT  , KC_Z ,  KC_X   ,  KC_C  ,   KC_V ,   KC_B ,                                        KC_N,   KC_M ,KC_COMM, KC_DOT ,KC_SLSH, KC_BSPC, \
                                KC_APP , KC_LALT,   NAV  , KC_LSFT,KC_LCTL,KC_NO,     KC_NO,KC_LCTL, KC_SPC,   SYM  ,KC_RGUI, GAMING),
/*
